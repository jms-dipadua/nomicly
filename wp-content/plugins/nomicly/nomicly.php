...
add_action('nomicly_user_report_hourly', 'nomicly_reporting');
...
//		wp_schedule_event($time, 'daily', 'nomicly_user_report_daily');
		wp_schedule_event($time, 'hourly', 'nomicly_user_report_hourly');
}  // DAILY REPORTS
...
wp_clear_scheduled_hook('nomicly_user_report_hourly');
