...
* <strong> FIXED </strong> many compatibility issues beetween the plugin and some Wordpress installations
* <strong> FIXED </strong> color scheme bug, dark color scheme is now working
* <strong> TWEAK </strong> Added extra class validation to avoid further compatibility issues
...
* Fixed many integration issues. Upgrade Highly Adisable.
